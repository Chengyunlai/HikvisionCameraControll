...
public interface
HCNetSDK extends StdCallLibrary {

    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(System.getProperty("user.dir") + "\\lib\\HCNetSDK.dll",
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
interface PlayCtrl extends StdCallLibrary
{
    ...
    boolean PlayM4_GetJPEG(int nPort, Pointer pJpeg, int nBufSize, IntByReference pJpegSize);
